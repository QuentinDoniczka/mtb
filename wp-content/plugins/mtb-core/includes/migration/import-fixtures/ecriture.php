<?php
/**
 * Écriture d'un contenu importé, et contrôle aval de ce qui a réellement été stocké.
 *
 * @package MTB\Core
 */
...
/*
 * SEUL FICHIER DU MODULE À ÉCRIRE. Il n'appelle ni wp_delete_post, ni wp_trash_post, ni
 * delete_post_meta : l'import ne supprime jamais rien.
 *
 * LES ANTISLASHS — la corruption silencieuse à éviter (contrat #29 §8)
 *
...
/**
 * Rattache la photo principale d'un contenu.
 *
 * @param int $post_id      Contenu porteur.
 ...
 *
 * Seconde raison d'être de ce contrôle : il compare la relecture à la valeur BRUTE du fichier, non
 * échappée. Toute erreur d'échappement devient donc un rejet nommé, sur un contenu déjà créé et
 * jamais supprimé. Il voit aussi ce que l'amont ne peut pas voir — le titre, le contenu, la photo
 * principale, qui n'ont aucun assainisseur de modèle.
 *
