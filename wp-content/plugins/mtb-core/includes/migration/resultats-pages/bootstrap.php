...
\WP_CLI::add_command(
	...
	array(
		...
		'longdesc'  => "## NOTES\n\n"
			...
			. "Les photos ne sont pas téléversées aujourd’hui : le dossier des captures n’est monté dans aucun conteneur. Les pages sont créées sans photo, l’emplacement n’existe pas dans le rendu, et le code de sortie reste 0. Une fois le dossier monté, « --photos=<dossier> » les versera.\n\n"
			...
			. "La fidélité des données à la capture de l’ancien site ne se vérifie pas ici : elle se vérifie hors ligne, avec « python concordance/concordance.py », qui lit le HTML archivé de « docs/ ». Ce dossier n’étant monté dans aucun conteneur, ce contrôle se lance depuis l’arbre de travail.\n\n"
			. "## EXAMPLES\n\n"
