...
- Avec un statut choisi, la phrase nomme ce statut, par exemple
  « Ce bloc n'affiche rien tant qu'aucune fiche de chien publiée n'a le statut « Reproducteur ». » :
  aucun chien ne porte ce statut. Repassez sur **Tous les statuts, groupés**, ou donnez ce statut à un
  chien.
