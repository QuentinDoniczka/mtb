...
![La liste Tous les chiens : à côté du titre Halan, la mention En sommeil, à la place où WordPress écrit déjà Brouillon](captures/sommeil-liste-chiens-mention.png)
...
![L'éditeur de la page d'accueil : la case Mettre ce contenu en sommeil, et juste en dessous l'encadré jaune d'avertissement sur la page d'accueil](captures/sommeil-page-accueil-avertissement.png)
