...
| Q5 | Hébergement de production et propriété du nom de domaine | la mise en ligne, **et désormais #48** | ⏳ en attente — **#48 (ouverte au lot 11) ne peut pas entrer dans un lot avant la réponse** : rien dans le dépôt ne garantit qu'un diagnostic PHP reste invisible en production, le correctif de #31 passant par un mécanisme Docker |
