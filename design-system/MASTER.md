...
- **Version** : 1.6 — 5 septembre 2026 (1.0 du 15 août 2026, 1.1 du 28 août 2026, 1.2 du 30 août
  2026, 1.3 et 1.4 du 31 août 2026, 1.5 du 1er septembre 2026 ; seuls les §5.1, §7.7, §9.3, §9.5,
  §10.2 et §10.3 sont amendés, cf. §16)
...
| Discipline | **Discipline** | Discipline | Liste fermée : **RING** · **IGP / RCI** · **Mondioring** · **Obéissance** · **Pistage** · **Recherche utilitaire** · **Sauvetage** · **Truffe** · **Autres disciplines**. La neuvième est la **rubrique fourre-tout**, dont le libellé est le **titre de section recopié du site source** — il n'est pas inventé. **Règle opposable** : un résultat se range dans la discipline que **la source** lui donne, **y compris quand une discipline nommée existe par ailleurs** ; on recopie le classement, on ne le corrige pas (Q14, tranchée le 2026-09-05). Cas d'espèce dans `docs/migration/reprise-resultats-pages.md`, section « Les faits d'élevage sur lesquels la chaîne a buté — non comblés ». |
| Année | **Année** | Année | |
...
| D3 | **Disciplines** — le brief §5.3 annonce « ~7 disciplines » puis en énumère **huit**. J'ai retenu **en 1.0** les huit énumérées (§10.2). Tranchée par **Q14, le 2026-09-05** : la liste en compte **neuf**, la neuvième étant la rubrique fourre-tout **Autres disciplines** (§10.2, révision 1.6). | rien — tranchée | l'éleveuse, tranchée le 2026-09-05 |
...
|---|---|---|---|
| 2026-09-05 | 1.6 | **§10.2 seul.** La ligne **Discipline** énumère désormais **neuf** valeurs : **Autres disciplines** est ajoutée en **neuvième position**, **libellé recopié au caractère près** de `mtb_resultat_disciplines()` (`wp-content/plugins/mtb-core/includes/query/resultat/bootstrap.php`), **l'ordre des huit premières restant inchangé** — c'est l'ordre que le docbloc de cette fonction déclare **gelé**, et rien n'y est permuté. La cellule porte maintenant ce que **Q14 a tranché le 2026-09-05** *et* **ce que Q14 a explicitement écarté** : les quatre lignes « Autres disciplines » du site source restent **groupées** sous ce libellé — **ni Agility, ni Cavage, ni Brevet Maitre Chien Drogue n'entrent dans la liste** comme disciplines nommées —, et l'option de déplacer `Qual. Chien de sauvetage` vers la discipline **Sauvetage**, qui existe pourtant et a son propre tableau sur la même page, a été **posée puis écartée, parce qu'elle corrigerait la source au lieu de la recopier**. C'est écrit pour qu'aucune chaîne future n'y voie un oubli à réparer : un fourre-tout dans une liste déclarée fermée ressemble à un provisoire, et l'anomalie qu'il porte est **visible sur la page publique**. D'où la **règle opposable** inscrite dans la cellule : un résultat se range dans la discipline que **la source** lui donne, y compris quand une discipline nommée existe par ailleurs. **D3 est marquée tranchée au §15**, et non retirée : sa première phrase — l'écart « ~7 » contre huit du brief §5.3 — reste vraie et reste écrite ; seule sa deuxième est historisée (« j'ai retenu **en 1.0** les huit énumérées »), parce que son renvoi à §10.2 serait **cassé par cette révision même**, à onze lignes de la table qu'il décrit. Rien d'autre n'est rouvert : palette, typographie, espacement, photographie et mise en page inchangés ; **§9.1 et §10.3 ne sont pas touchés**, leurs écarts ayant chacun leur propre dette — §10.3 a son issue **#43** — et **la ligne Statut du §10.2 n'est pas rouverte**, la dette **T74** (formes plurielles) n'étant pas du ressort de cette révision. **Aucune ligne de thème ni d'extension n'en découle : le code était déjà juste, c'est le document qui était périmé.** | Dette **T54**, relevée au lot 9, garée sur **Q14** jusqu'au 2026-09-05. L'appui qui rend l'affaire nette : la **décision 11** de `docs/ETAT.md`, **révisée le 2026-08-16**, affirme depuis presque trois semaines que les neuf graphies sont « celles de `MASTER.md` §10.2 » — c'était **faux depuis ce jour-là**, et cette révision est ce qui le rend vrai. L'autorité du neuvième libellé n'est donc pas cette chaîne : c'est une **recopie, pas un arbitrage**. Il est corroboré par cinq écritures indépendantes du dépôt — le code, les données de migration, et **trois fiches du guide de l'éleveuse qui écrivent déjà « neuf »** |
